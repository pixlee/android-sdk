 ...
 */
public class TransparentStyledPlayerView extends FrameLayout implements AdViewProvider {
    ...
    private final class ComponentListener
        ...
        public void onTracksInfoChanged(TracksInfo tracksInfo) {
            ...
            Player player = Assertions.checkNotNull(TransparentStyledPlayerView.this.player);
